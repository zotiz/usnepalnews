...
const Bussiness = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-2">
      <div className="col-span-2 text-xl font-semibold bg-[#E5F7F6] rounded p-8">
        <span className="border-b-2 pb-[9px] border-[#0DB4B0] pr-2 text-[#0DB4B0]">
        बिजनेस
        </span>

        <div className=" bg-gray-400 h-[1px] my-2" />
        <div className="text-black flex gap-4 my-4">
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <p className="text-[16px] font-light text-gray-800">
              ...
              <br />
              <button className="text-[12px] bg-[#0DB4B0] text-white py-1 px-2 rounded-lg mt-2">
                Read More
              </button>
            </p>
          </div>
        </div>
        <div className="text-gray-900 grid grid-cols-2 gap-4 mt-6">
