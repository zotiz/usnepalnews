...
const InterviewAndLiterature = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-2">
      <div className="col-span-1 text-xl font-semibold rounded py-8">
        <span className="border-b-2 pb-[9px] border-[#04B0D8] pr-2 text-[#04B0D8]">
         साहित्य
        </span>
        ...
        <div className="flex flex-col gap-2 my-4">
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <p className="text-[16px] font-light text-gray-800">
              ...
              <br />
              <button className="text-[12px] bg-[#04B0D8] text-white py-1 px-4 rounded-full mt-2">
                Read More
              </button>
            </p>
          </div>
        </div>
        <div className="text-white flex flex-col gap-3  mt-6">
      ...
      <div className="col-span-1 text-xl font-semibold rounded py-8">
        <span className="border-b-2 pb-[9px] border-[#feb509]  text-[#feb509]">
        अन्तरवार्ता
        </span>
        <div className=" bg-gray-400 h-[1px] my-2" />
        <div className="flex flex-col gap-2 my-4">
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <p className="text-[16px] font-light text-gray-800">
              ...
              केही नेताको बुझाइमा भारत गमन बिपीको आत्मनिर्वासनको...
              <br />
              <button className="text-[12px] bg-[#feb509] text-white py-1 px-4 rounded-full mt-2">
                Read More
              </button>
            </p>
          </div>
...
export default InterviewAndLiterature
